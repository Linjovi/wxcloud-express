  ...
  return (
    <div className="flex flex-col items-center justify-center h-[60vh] space-y-8 p-4 text-center">
      ...
      <div className="flex space-x-2 pt-2">
        ...
        <div className="w-3 h-3 bg-orange-400 rounded-full animate-bounce animation-delay-200" style={{ animationDelay: '0.2s' }}></div>
        <div className="w-3 h-3 bg-orange-500 rounded-full animate-bounce animation-delay-400" style={{ animationDelay: '0.4s' }}></div>
      </div>
    </div>
  );
};
